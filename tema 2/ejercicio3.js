...
function ejercicio3() {
    ...
    miPosicion = new google.maps.Marker({
        position: {lat: parseFloat(geocoder.latitude), lng: parseFloat(geocoder.longitude)},
        map: map,
    ...
    direccion = "";
    puntoAnterior = 0;
    puntoActual = miPosicion.position;
...
function muestraPosicionContinua(posicion)
{
    ...
    content.innerHTML ="<p><strong>Latitud:</strong> " + lati + "</p><p><strong>Longitud:</strong> " + long +
        "</p><p><strong>Distancia:</strong> " + distancia;
